...
if __name__ == '__main__':
    ...
    for subj in subjs:
        ...
        if len(bids_t1s) <= 0:
            ...
            args_list1.append([subject_id, sub_t1, subj_recon_path, args.rewrite])
            ...
            # combine T1
                ...
                args_list1.append([subject_id, str(sub_t1), subj_recon_path])

    pool = Pool(Multi_Num)
    pool.starmap(preprocess, args_list1)
    pool.close()
    pool.join()
