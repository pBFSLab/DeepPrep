...
def run_rigid_registration(subject_id, script, subj_anat_dir, T1_file, template, mp, template_space):
    moved = Path(subj_anat_dir) / f'{subject_id}_space-{template_space}_res-01_desc-affine_T1w.nii.gz'
...
if __name__ == '__main__':
    ...
    run_rigid_registration(args.subject_id, args.synth_script, subj_func_dir, args.t1_native2mm, template, args.synth_model_path, args.template_space)
