...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="plot subject vol surf fig")
    ...
    Vol_Surface_savepath_svg = subject_resultdir / f'{subject_id}_desc-volsurf_T1w.svg'
    print(f'>>> {Vol_Surface_savepath_svg}')
