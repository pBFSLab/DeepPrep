...
if __name__ == '__main__':
    ...
    parser.add_argument('--bold_preprocess_path', help='bold_preprocess dir', required=True)
    ...
    --bold_preprocess_path /mnt/ngshare/DeepPrep/light_sample_output_test/BOLD
    ...
    bold_preprocess_path = Path(args.bold_preprocess_path)
    ...
    input_surfdir = subjects_dir / subject_id / 'surf'
    output_giidir = bold_preprocess_path / subject_id / 'anat'
