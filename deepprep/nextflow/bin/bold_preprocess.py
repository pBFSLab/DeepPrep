...
if __name__ == '__main__':
    ...
    if args.bold_sdc.upper() == 'TRUE':  # run fieldmap
        ...
        boldresampled_file.symlink_to(f'{confounds_dir_path}/{bold_id}_boldresampled.nii.gz')
        ...
        boldmask_file.symlink_to(f'{confounds_dir_path}/{bold_id}_bold_average_corrected_brain_mask_maths.nii.gz')
        ...
        motion_txt.symlink_to(f'{confounds_dir_path}/{bold_id}_motion_params.txt')
        ...
        rel_file.symlink_to(f'{confounds_dir_path}/{bold_id}_bold_mcf.nii.gz_rel.rms')
