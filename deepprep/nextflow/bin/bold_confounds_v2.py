...
def bold_confounds_v2(bold_preprocess_dir, bold, bold_mask, movpar_file, rmsd_file, boldref2anat_xfm, skip_vols, t1w_tpms, t1w_mask, source_file):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--bold_file", required=True)  # subject_boldfile_txt
    ...
    boldref = confounds_dir_path / f'{args.bold_id}_boldresampled.nii.gz'
    ...
    bold_confounds_v2(args.bold_preprocess_dir, boldref, bold_mask, movpar_file, rmsd_file, str(boldref2anat_xfm), skip_vols,
