...
if __name__ == '__main__':
    ...
    for subj in subjs:
        ...
        # bold warp
        resid = 'NC_15_bld010_rest_reorient_skip_faln_mc_g1000000000_bpss_resid.nii.gz'
        resid_file = subj_func_path / f'sub-{subj}_resid.nii.gz'
        reg_file = subj_func_path / f'sub-{subj}_bbregister.register.dat'
