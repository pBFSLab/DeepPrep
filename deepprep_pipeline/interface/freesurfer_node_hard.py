...
class OrigAndRawavg(BaseInterface):
    ...
    def _run_interface(self, runtime):
        ...
        cmd = f"recon-all -subject {self.inputs.subject_id} -i {files} -motioncor -talairach -nuintensitycor" \
              f" -normalization {fsthreads}"
        run_cmd_with_timing(cmd)
...
class Brainmask(BaseInterface):
    ...
    def create_sub_node(self):
        from interface.create_node_structure_hard import create_UpdateAseg_node
...
class Filled(BaseInterface):
    ...
    def create_sub_node(self):
        from interface.create_node_structure_hard import create_FastCSR_node
...
class WhitePreaparc1(BaseInterface):
    ...
    def create_sub_node(self):
        from interface.create_node_structure_hard import create_InflatedSphere_node
...
class InflatedSphere(BaseInterface):
    ...
    def create_sub_node(self):
        from interface.create_node_structure_hard import create_FeatReg_node
...
class WhitePialThickness1(BaseInterface):
    ...
    def create_sub_node(self):
        from interface.create_node_structure_hard import create_Curvstats_node, create_BalabelsMult_node, \
...
class Cortribbon(BaseInterface):
    ...
    def create_sub_node(self):
        from interface.create_node_structure_hard import create_Parcstats_node
...
class Parcstats(BaseInterface):
    ...
    def create_sub_node(self):
        from interface.create_node_structure_hard import create_Aseg7_node
...
class JacobianAvgcurvCortparc(BaseInterface):
    ...
    def create_sub_node(self):
        from interface.create_node_structure_hard import create_WhitePialThickness1_node
